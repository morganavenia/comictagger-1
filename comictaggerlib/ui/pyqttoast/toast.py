...
class Toast(QDialog):
    ...
    def eventFilter(self, watched: bool, event: QEvent) -> bool:
    ...
    def __update_position_x(self, animate: bool = True) -> None:
    ...
    def __update_position_y(self, animate: bool = True) -> None:
    ...
    def __get_bounds(self) -> QRect:
        ...
        return current_screen.geometry()  # type: ignore[union-attr]

    def __calculate_position(self) -> tuple[int, int]:
        ...
        if Toast.__position == ToastPosition.BOTTOM_RIGHT:
            x = bounds.width() - self.__toast_widget.width() - Toast.__offset_x + bounds.x()
            y = bounds.height() - self.__toast_widget.height() - Toast.__offset_y + bounds.y() - y_offset
            ...
            x = bounds.x() + bounds.width() / 2 - self.__toast_widget.width() / 2
            if y_offset == 0:
                y = bounds.y() + bounds.height() / 2 - self.__toast_widget.height() / 2 + y_offset
            else:
                y_start = bounds.y() + bounds.height() / 2 - self.__currently_shown[0].__toast_widget.height() / 2
                y = y_start + y_offset
    ...
    def __setup_ui(self) -> None:
        ...
        close_button_section_height = close_button_margins.top() + close_button_height + close_button_margins.bottom()
        ...
        if height < self.minimumHeight():
            ...
            title_width = (
                ...
                .boundingRect(QRect(0, 0, 0, 0), Qt.TextFlag.TextWordWrap, self.__title_label.text())
                .width()
            )
            text_width = (
                self.__text_label.fontMetrics()
                .boundingRect(QRect(0, 0, 0, 0), Qt.TextFlag.TextWordWrap, self.__text_label.text())
                .width()
            )
            ...
            title_width = (
                self.__title_label.fontMetrics()
                .boundingRect(QRect(0, 0, temp_width, 0), Qt.TextFlag.TextWordWrap, self.__title_label.text())
                .width()
            )
            if self.__title != "":
                title_height = (
            ...
            text_width = (
                self.__text_label.fontMetrics()
                .boundingRect(QRect(0, 0, temp_width, 0), Qt.TextFlag.TextWordWrap, self.__text_label.text())
                .width()
            )
            if self.__text != "":
                text_height = (
            ...
            while temp_width <= width:
                ...
                temp_height = (
                    self.__margins.top()
                    + max(icon_section_height, temp_text_section_height, close_button_section_height)
                    + self.__margins.bottom()
                    + duration_bar_height
                )
        ...
        if self.__show_icon:
            ...
            self.__icon_widget.move(
                self.__margins.left() + self.__icon_section_margins.left() + self.__icon_margins.left(),
                self.__margins.top()
                + self.__icon_section_margins.top()
                + self.__icon_margins.top()
        ...
        if self.__title == "" and self.__text != "":
            self.__text_label.move(self.__text_label.x(), int((height - text_height - duration_bar_height) / 2))

        elif self.__title != "" and self.__text == "":
            self.__title_label.move(self.__title_label.x(), int((height - title_height - duration_bar_height) / 2))
        ...
        if self.__close_button_alignment == ToastButtonAlignment.TOP:
            self.__close_button.move(
                width - close_button_width - close_button_margins.right() - self.__margins.right(),
    ...
    def __remove_widget_event_filter(self) -> None:
    ...
    def setShowDurationBar(self, on: bool) -> None:
    ...
    def setIcon(self, icon: QPixmap | ToastIcon) -> None:
    ...
    def setShowIcon(self, on: bool) -> None:
    ...
    def setShowIconSeparator(self, on: bool) -> None:
    ...
    def setIconSeparatorWidth(self, width: int) -> None:
    ...
    def setCloseButtonIcon(self, icon: QPixmap | ToastIcon) -> None:
    ...
    def setShowCloseButton(self, show: bool) -> None:
    ...
    def setCloseButtonIconSize(self, size: QSize) -> None:
        """Get the size of the close button icon
    ...
    def setCloseButtonSize(self, size: QSize) -> None:
    ...
    def setCloseButtonWidth(self, width: int) -> None:
    ...
    def setCloseButtonHeight(self, height: int) -> None:
    ...
    def setCloseButtonAlignment(self, alignment: ToastButtonAlignment) -> None:
    ...
    def setFadeInDuration(self, duration: int) -> None:
    ...
    def setFadeOutDuration(self, duration: int) -> None:
    ...
    def setResetDurationOnHover(self, on: bool) -> None:
    ...
    def setStayOnTop(self, on: bool) -> None:
    ...
    def setBorderRadius(self, border_radius: int) -> None:
    ...
    def setTitleColor(self, color: QColor) -> None:
    ...
    def setIconColor(self, color: QColor | None) -> None:
    ...
    def setIconSeparatorColor(self, color: QColor) -> None:
    ...
    def setCloseButtonIconColor(self, color: QColor | None) -> None:
        ...
        recolored_image = IconUtils.recolor_image(
            QIcon(self.__close_button_icon).pixmap(self.__close_button.iconSize()).toImage(), color
        )
    ...
    def setDurationBarColor(self, color: QColor) -> None:
    ...
    def setMarginLeft(self, margin: int) -> None:
    ...
    def setMarginTop(self, margin: int) -> None:
    ...
    def setMarginRight(self, margin: int) -> None:
    ...
    def setMarginBottom(self, margin: int) -> None:
    ...
    def setIconMargins(self, margins: QMargins) -> None:
    ...
    def setIconMarginLeft(self, margin: int) -> None:
    ...
    def setIconMarginTop(self, margin: int) -> None:
    ...
    def setIconMarginRight(self, margin: int) -> None:
    ...
    def setIconMarginBottom(self, margin: int) -> None:
    ...
    def setIconSectionMargins(self, margins: QMargins) -> None:
    ...
    def setIconSectionMarginLeft(self, margin: int) -> None:
    ...
    def setIconSectionMarginTop(self, margin: int) -> None:
    ...
    def setIconSectionMarginRight(self, margin: int) -> None:
    ...
    def setIconSectionMarginBottom(self, margin: int) -> None:
    ...
    def setTextSectionMargins(self, margins: QMargins) -> None:
    ...
    def setTextSectionMarginLeft(self, margin: int) -> None:
    ...
    def setTextSectionMarginTop(self, margin: int) -> None:
    ...
    def setTextSectionMarginRight(self, margin: int) -> None:
    ...
    def setTextSectionMarginBottom(self, margin: int) -> None:
    ...
    def setCloseButtonMargins(self, margins: QMargins) -> None:
    ...
    def setCloseButtonMarginLeft(self, margin: int) -> None:
    ...
    def setCloseButtonMarginTop(self, margin: int) -> None:
    ...
    def setCloseButtonMarginRight(self, margin: int) -> None:
    ...
    def setCloseButtonMarginBottom(self, margin: int) -> None:
    ...
    def setTextSectionSpacing(self, spacing: int) -> None:
    ...
    def applyPreset(self, preset: ToastPreset) -> None:
    ...
    def __update_stylesheet(self) -> None:
        """Update the stylesheet of the toast"""

        self.__toast_widget.setStyleSheet(
            "background: {};" "border-radius: {}px;".format(self.__background_color.name(), self.__border_radius)
        )
        ...
        self.__icon_separator.setStyleSheet(f"background: {self.__icon_separator_color.name()};")

        self.__title_label.setStyleSheet(f"color: {self.__title_color.name()};")
        self.__text_label.setStyleSheet(f"color: {self.__text_color.name()};")

    @staticmethod
    def __update_currently_showing_position_xy(animate: bool = True) -> None:
    ...
    @staticmethod
    def __update_currently_showing_position_x(animate: bool = True) -> None:
    ...
    @staticmethod
    def __update_currently_showing_position_y(animate: bool = True) -> None:
    ...
    @staticmethod
    def setMaximumOnScreen(maximum_on_screen: int) -> None:
    ...
    @staticmethod
    def setSpacing(spacing: int) -> None:
    ...
    @staticmethod
    def setOffsetX(offset_x: int) -> None:
    ...
    @staticmethod
    def setOffsetY(offset_y: int) -> None:
    ...
    @staticmethod
    def setOffset(offset_x: int, offset_y: int) -> None:
    ...
    @staticmethod
    def setPositionRelativeToWidget(widget: QWidget | None) -> None:
    ...
    @staticmethod
    def setMovePositionWithWidget(on: bool) -> None:
    ...
    @staticmethod
    def setAlwaysOnMainScreen(on: bool) -> None:
    ...
    @staticmethod
    def setFixedScreen(screen: QScreen | None) -> None:
    ...
    @staticmethod
    def setPosition(position: ToastPosition) -> None:
